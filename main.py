...
from nquentung import NquenTung

__CHANNEL_USERNAME__ = "GameGuardianLua"
__GROUP_USERNAME__   = "LuaGGChatGroup"
...
def banner(console):
    ...
    brand_name = figlet_format('NquenTung', font='drpepper')
    colors = [
